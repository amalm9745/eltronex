...
class ProductVariantModel(models.Model):
    ...
    ram=models.CharField(max_length=50,null=True,default="")
    storage=models.CharField(max_length=50,null=True,default="")
    display=models.CharField(max_length=100,null=True,default="")
    camera=models.CharField(max_length=100,null=True,default="")
    battery=models.CharField(max_length=50,null=True,default="")
    processor=models.CharField(max_length=100,null=True,default="")
    operating_system=models.CharField(max_length=100,null=True,default="")
    display_size=models.CharField(max_length=50,null=True,default="")
    sound_output=models.CharField(max_length=50,null=True,default="")
    apps=models.CharField(max_length=100,null=True,default="")
    launch_year=models.CharField(max_length=50,null=True,default="")
